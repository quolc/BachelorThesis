...
While the annotations made by techniques mentioned above are mainly used for managing existing contents, some researches focusing on using annotations for editing movies to create attractive contents have been carried out. %some annotations can be used for editing movies to create attractive contents.
